...
if __name__ == '__main__':
    ...
    try:
        ...
        fn = '/home/lzw/catkin_ws/src/map_deal/script/mapRecognition/pic/debug/自适应阈值化_2_800轮廓/image_closed_better.jpg'
    print help_message
    ...
    while True:
        ...
        if ch == ord('c'):
            ...
            update()
        if ch == ord('s'):
            cv2.imwrite("./pic/debug/floodfilled.jpg", flooded)
            print '成功保存图像'
