...
public:
    ...
    */
    void image_process(cv::Mat img)
    {
       ...
       cv::waitKey();
       cout <<"now wait for input key." <<endl;
       ...
       int bottom_bar_height= img_out.rows/7 ;
...
int main(int argc, char** argv)
{
    ...
    Mat inMap_resize;
    resize(inMap, inMap_resize, Size(inMap.cols/3, inMap.rows/3));
